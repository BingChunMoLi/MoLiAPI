...
(
    ...
    `obs_url_cn`         varchar(120) character set utf8mb4 collate utf8mb4_general_ci default null comment '' 中国版obs地址,
    已废弃 '',
    `obs_url_en`         varchar(120) character set utf8mb4 collate utf8mb4_general_ci default null comment '' 国际版obs地址,
    已废弃 '',
