  ...
  <div class="auth-page">
    <el-form ref="ruleFormRef" :model="user" :rules="rules" class="auth-form" label-position="top" status-icon>
      <div class="auth-title">
        <h1>初始化后台</h1>
        <span>首次启动时创建管理员账号</span>
      </div>
      <el-alert show-icon title="当前系统还没有管理员账号，请先完成初始化。" type="info"/>
      ...
      <div class="form-actions">
        <el-button :loading="loading" type="primary" @click="submitForm(ruleFormRef)">创建账号</el-button>
